var SKULPT=SKULPT||{version:"1.0.1"};console.log("Using SKULPT "+SKULPT.version);
...
SKULPT.GpuSkulpt.prototype.__init=function(){this.__checkExtensions();this.__setupShaders();this.__setupRttScene();this.__setupVtf();this.supportsTextureFloatLinear?(this.__imageDataTexture=new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,THREE.FloatType,void 0,THREE.ClampToEdgeWrapping,THREE.ClampToEdgeWrapping,THREE.LinearFilter,THREE.LinearMipMapLinearFilter),this.__imageDataTexture.generateMipmaps=!0):(this.__imageDataTexture=new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,
THREE.FloatType,void 0,THREE.ClampToEdgeWrapping,THREE.ClampToEdgeWrapping,THREE.NearestFilter,THREE.NearestFilter),this.__imageDataTexture.generateMipmaps=!1)};
SKULPT.GpuSkulpt.prototype.__checkExtensions=function(a){a=this.__renderer.context;if(!a.getExtension("OES_texture_float"))throw a="No support for floating point textures. Extension not available: OES_texture_float",alert(a),Error(a);this.supportsTextureFloatLinear=null!==a.getExtension("OES_texture_float_linear");console.log("Texture float linear filtering support: "+this.supportsTextureFloatLinear);if(!a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS))throw a="Vertex textures not supported on your graphics card",
alert(a),Error(a);};
...
1,0,0),b:new THREE.Vector4(0,0,1,0),a:new THREE.Vector4(0,0,0,1)}};
SKULPT.GpuSkulpt.prototype.__setupRttScene=function(){this.__rttScene=new THREE.Scene;this.__rttCamera=new THREE.OrthographicCamera(-this.__halfSize,this.__halfSize,this.__halfSize,-this.__halfSize,-1E4,1E4);this.__rttQuadGeom=new THREE.PlaneGeometry(this.__size,this.__size);this.__rttQuadMesh=new THREE.Mesh(this.__rttQuadGeom,this.__skulptMaterial);this.__rttScene.add(this.__rttQuadMesh);this.__rttRenderTarget1=this.supportsTextureFloatLinear?new THREE.WebGLRenderTarget(this.__res,this.__res,this.__linearFloatRgbParams):
new THREE.WebGLRenderTarget(this.__res,this.__res,this.__nearestFloatRgbParams);this.__rttRenderTarget1.generateMipmaps=!1;this.__rttRenderTarget2=this.__rttRenderTarget1.clone();this.__rttCombinedLayer=this.__rttRenderTarget1.clone();this.__rttProxyRenderTarget=this.supportsTextureFloatLinear?new THREE.WebGLRenderTarget(this.__proxyRes,this.__proxyRes,this.__linearFloatRgbParams):new THREE.WebGLRenderTarget(this.__proxyRes,this.__proxyRes,this.__nearestFloatRgbParams);this.__rttProxyRenderTarget.generateMipmaps=
!1;this.__rttFloatEncoderRenderTarget=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__nearestFloatRgbaParams);this.__rttFloatEncoderRenderTarget.generateMipmaps=!1};
