var SKULPT=SKULPT||{version:"1.1.0-prealpha-1"};console.log("Using SKULPT "+SKULPT.version);
...
this.__size/this.__res;this.__texelSize=1/this.__res;this.__imageProcessedData=new Float32Array(4*this.__res*this.__res);this.__loadSculptProcessedData=new Float32Array(4*this.__res*this.__res);this.__isSculpting=!1;this.__sculptUvPos=new THREE.Vector2;this.__cursorHoverColor=new THREE.Vector3(.4,.4,.4);this.__cursorAddColor=new THREE.Vector3(.3,.5,.1);this.__cursorRemoveColor=new THREE.Vector3(.5,.2,.1);this.__shouldClear=this.__isLoading=!1;this.__linearFloatRgbParams={minFilter:THREE.LinearFilter,
magFilter:THREE.LinearFilter,wrapS:THREE.ClampToEdgeWrapping,wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.FloatType};this.__nearestFloatRgbParams={minFilter:THREE.NearestFilter,magFilter:THREE.NearestFilter,wrapS:THREE.ClampToEdgeWrapping,wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.FloatType};this.__nearestUnsignedByteRgbaParams={minFilter:THREE.NearestFilter,magFilter:THREE.NearestFilter,wrapS:THREE.ClampToEdgeWrapping,
wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBAFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.UNSIGNED_BYTE};this.__pixelByteData=new Uint8Array(this.__res*this.__res*4);this.__proxyPixelByteData=new Uint8Array(this.__proxyRes*this.__proxyRes*4);this.__callbacks={};this.__init()};
...
THREE.ClampToEdgeWrapping,THREE.LinearFilter,THREE.LinearMipMapLinearFilter),this.__imageDataTexture.generateMipmaps=!0,this.__loadSculptDataTexture=new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,THREE.FloatType,void 0,THREE.ClampToEdgeWrapping,THREE.ClampToEdgeWrapping,THREE.LinearFilter,THREE.LinearMipMapLinearFilter),this.__loadSculptDataTexture.generateMipmaps=!0):(this.__imageDataTexture=new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,THREE.FloatType,void 0,
THREE.ClampToEdgeWrapping,THREE.ClampToEdgeWrapping,THREE.NearestFilter,THREE.NearestFilter),this.__imageDataTexture.generateMipmaps=!1,this.__loadSculptDataTexture=new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,THREE.FloatType,void 0,THREE.ClampToEdgeWrapping,THREE.ClampToEdgeWrapping,THREE.NearestFilter,THREE.NearestFilter),this.__loadSculptDataTexture.generateMipmaps=!1)};
...
this.__res,this.__nearestUnsignedByteRgbaParams);this.__rttFloatEncoderRenderTarget.generateMipmaps=!1;this.__clearRenderTarget(this.__rttFloatEncoderRenderTarget,0,0,0,0)};SKULPT.GpuSkulpt.prototype.__clearRenderTarget=function(a,b,c,f,e){this.__rttQuadMesh.material=this.__clearMaterial;this.__clearMaterial.uniforms.uColor.value.set(b,c,f,e);this.__renderer.render(this.__rttScene,this.__rttCamera,a,!1)};
SKULPT.GpuSkulpt.prototype.__setupVtf=function(){this.__mesh.material=new THREE.ShaderMaterial({uniforms:THREE.UniformsUtils.merge([THREE.UniformsLib.lights,THREE.UniformsLib.shadowmap,{uTexture:{type:"t",value:null},uTexelSize:{type:"v2",value:new THREE.Vector2(1/this.__res,1/this.__res)},uTexelWorldSize:{type:"v2",value:new THREE.Vector2(this.__gridSize,this.__gridSize)},uHeightMultiplier:{type:"f",value:1},uBaseColor:{type:"v3",value:new THREE.Vector3(.6,.8,0)},uShowCursor:{type:"i",value:0},uCursorPos:{type:"v2",
value:new THREE.Vector2},uCursorRadius:{type:"f",value:0},uCursorColor:{type:"v3",value:new THREE.Vector3}}]),vertexShader:this.__shaders.vert.heightMap,fragmentShader:this.__shaders.frag.lambertCursor,lights:!0})};
...
this.__imageDataTexture,this.__skulptMaterial.uniforms.uSculptTexture1.value=this.__rttRenderTarget2,this.__skulptMaterial.uniforms.uIsSculpting.value=this.__isSculpting,this.__skulptMaterial.uniforms.uSculptPos.value.copy(this.__sculptUvPos),this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTarget1,!1),this.__swapRenderTargets(),this.__isSculpting=!1,this.__updateCombinedLayers=!0);this.__isLoading&&(this.__rttQuadMesh.material=this.__textureToRenderTargetMaterial,this.__textureToRenderTargetMaterial.uniforms.uTexture.value=
this.__loadSculptDataTexture,this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTarget1,!1),this.__swapRenderTargets(),this.__isLoading=!1,this.__updateCombinedLayers=!0);if(this.__updateCombinedLayers&&(this.__rttQuadMesh.material=this.__combineTexturesMaterial,this.__combineTexturesMaterial.uniforms.uTexture1.value=this.__imageDataTexture,this.__combineTexturesMaterial.uniforms.uTexture2.value=this.__rttRenderTarget2,this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttCombinedLayer,
!1),this.__updateCombinedLayers=!1,this.__mesh.material.uniforms.uTexture.value=this.__rttCombinedLayer,this.__callbacks.hasOwnProperty("update"))){a=this.__callbacks.update;var b,c;b=0;for(c=a.length;b<c;b++)a[b]()}};SKULPT.GpuSkulpt.prototype.__swapRenderTargets=function(){var a=this.__rttRenderTarget1;this.__rttRenderTarget1=this.__rttRenderTarget2;this.__rttRenderTarget2=a};
SKULPT.GpuSkulpt.prototype.setBrushSize=function(a){a/=2*this.__size;this.__skulptMaterial.uniforms.uSculptRadius.value=a;this.__mesh.material.uniforms.uCursorRadius.value=a};SKULPT.GpuSkulpt.prototype.setBrushAmount=function(a){this.__skulptMaterial.uniforms.uSculptAmount.value=a};
SKULPT.GpuSkulpt.prototype.loadFromImageData=function(a,b,c){var f,e=99999,d,g;d=0;for(g=this.__imageProcessedData.length;d<g;d++)f=c?Math.abs(a[d]/255-.5):a[d]/255,this.__imageProcessedData[d]=f*b,this.__imageProcessedData[d]<e&&(e=this.__imageProcessedData[d]);d=0;for(g=this.__imageProcessedData.length;d<g;d++)this.__imageProcessedData[d]-=e;this.__imageDataTexture.image.data=this.__imageProcessedData;this.__imageDataTexture.needsUpdate=!0;this.__skulptMaterial.uniforms.uBaseTexture.value=this.__imageDataTexture;
...
SKULPT.GpuSkulpt.prototype.hideCursor=function(){this.__mesh.material.uniforms.uShowCursor.value=0};SKULPT.GpuSkulpt.prototype.getSculptDisplayTexture=function(){return this.__rttCombinedLayer};SKULPT.GpuSkulpt.prototype.__getPixelByteDataForRenderTarget=function(a,b,c,f){var e=this.__renderer.getContext();e.bindFramebuffer(e.FRAMEBUFFER,a.__webglFramebuffer);e.readPixels(0,0,c,f,e.RGBA,e.UNSIGNED_BYTE,b);e.bindFramebuffer(e.FRAMEBUFFER,null)};
SKULPT.GpuSkulpt.prototype.__getPixelEncodedByteData=function(a,b,c,f,e){this.__rttQuadMesh.material=this.__rttEncodeFloatMaterial;this.__rttEncodeFloatMaterial.uniforms.uTexture.value=a;this.__rttEncodeFloatMaterial.uniforms.uChannelMask.value.copy(this.__channelVectors[c]);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttFloatEncoderRenderTarget,!1);this.__getPixelByteDataForRenderTarget(this.__rttFloatEncoderRenderTarget,b,f,e)};SKULPT.GpuSkulpt.prototype.getPixelFloatData=function(){return this.getPixelFloatDataForLayer(SKULPT.LAYER.COMBINED)};
SKULPT.GpuSkulpt.prototype.getPixelFloatDataForLayer=function(a){this.__getPixelEncodedByteData(a==SKULPT.LAYER.BASE?this.__imageDataTexture:a==SKULPT.LAYER.SCULPT?this.__rttRenderTarget2:this.__rttCombinedLayer,this.__pixelByteData,"r",this.__res,this.__res);return new Float32Array(this.__pixelByteData.buffer)};
SKULPT.GpuSkulpt.prototype.setPixelFloatData=function(a){var b,c,f,e,d;b=0;for(f=this.__res;b<f;b++)for(c=0,e=this.__res;c<e;c++)d=b*this.__res+c,this.__loadSculptProcessedData[4*d]=a[(f-1-b)*this.__res+c],this.__loadSculptProcessedData[4*d+1]=0,this.__loadSculptProcessedData[4*d+2]=0,this.__loadSculptProcessedData[4*d+3]=0;this.__loadSculptDataTexture.image.data=this.__loadSculptProcessedData;this.__isLoading=this.__loadSculptDataTexture.needsUpdate=!0};
...
SKULPT.GpuSkulpt.prototype.addCallback=function(a,b){this.__callbacks.hasOwnProperty(a)||(this.__callbacks[a]=[]);if(b)if("function"===typeof b)this.__callbacks[a].push(b);else throw Error("Specified callbackFn is not a function");else throw Error("Callback function not defined");};SKULPT.ADD=1;SKULPT.REMOVE=2;SKULPT.LAYER={BASE:1,SCULPT:2,COMBINED:3};
